...
<html>
	...
	<body id="bodyfront">
		...
		<div id="containertravels">
			<div id="travelsbox">
				<h1>Zinda Park</h1><br><br>
				<img src="image/zin.jpg" id="travelspic"><br>

				<a href="Zinda.php"><span id="frontadminsubmit">Click</span></a>
			</div>

			<div id="travelsbox">
				<h1>Nuhash Polli</h1><br><br>
				<img src="image/nu.jpg" id="travelspic"><br>
			...
			<div id="travelsbox">
				...
				<img src="image/saf.jpg" id="travelspic"><br>
